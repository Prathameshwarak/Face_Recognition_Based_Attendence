...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'kaushaltrivedi268@gmail.com' ")
...
def TakeImages(columns=None):
    check_haarcascadefile()
    print("Before opening the camera")
    cam = cv2.VideoCapture(1,cv2.CAP_DSHOW)

    print("After opening the camera")
